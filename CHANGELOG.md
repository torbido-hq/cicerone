...
- Static project site under `website/` (landing + docs rendered from
  `docs/*.md`) with dashboard screenshot and pipeline diagram; Tailwind v4
  + typography plugin, built in CI and deployed to Pages at
